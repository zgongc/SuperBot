...
class Strategy(BaseStrategy):
    ...
    def __init__(self):
        ...
        # STRATEGY METADATA
        # ====================================================================
        self.strategy_name = "simple_rsi_ai"
        self.strategy_version = "1.0.0"
        self.description = "simple_rsi_ai_strategy"
        self.author = "SuperBot Team"
        self.created_date = "2026-12-05"

        # ====================================================================
        # BACKTEST CONFIGURATION
        # ====================================================================
        self.backtesting_enabled = True
        self.backtest_start_date = "2025-06-01T00:00"
        self.backtest_end_date = "2026-07-30T00:00"
        ...
        # V2 checkpoint format - scaler is embedded in checkpoint
        #self.ai_model_path = "data/checkpoints/ai/global_best.pt"
        #self.ai_confidence_threshold = 0.6  # Minimum confidence for trade

        # ════════════════════════════════════════════════════════════
        # AI CONFIG - Signal Intelligence
        # ════════════════════════════════════════════════════════════
        # AI modeli şu kararları destekleyebilir:
        # 1. Entry Decision: Sinyalin kalitesini değerlendir (win_probability)
        # 2. TP/SL Optimization: Optimal TP/SL öner (optimal_tp, optimal_sl)
        # 3. Position Sizing: Risk bazlı pozisyon boyutu
        # 4. Exit Timing: Çıkış zamanlaması
        # 5. Break Even & Trailing: Dinamik SL yönetimi
        # ════════════════════════════════════════════════════════════
