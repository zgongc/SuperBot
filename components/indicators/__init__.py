...
INDICATOR_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    'aisignal': {
        ...
        'description': 'AI Transformer Model Signal Indicator',
        'default_params': {
    ...
    'ema_ribbon': {
        ...
        'category': IndicatorCategory.COMBO,
        'type': IndicatorType.MULTIPLE_VALUES,
        'description': 'EMA Ribbon (Çoklu EMA Bantları)',
    ...
    'smart_grok': {
        ...
        'category': IndicatorCategory.COMBO,
        'type': IndicatorType.SINGLE_VALUE,
        'description': 'Smart Money Concept (SMC) - Geliştirilmiş versiyon',
    ...
    'smart_money': {
        ...
        'category': IndicatorCategory.COMBO,
        'type': IndicatorType.SINGLE_VALUE,
        'description': 'Smart Money Concept (SMC) Sistemi',
    ...
    'cointegration': {
        ...
        'type': IndicatorType.SINGLE_VALUE,
        'description': 'Cointegration (Eş-bütünleşme)',
    ...
    'correlation': {
        ...
        'category': IndicatorCategory.STATISTICAL,
        'type': IndicatorType.SINGLE_VALUE,
        'description': 'Correlation (Korelasyon)',
    ...
    'linear_regression': {
        ...
        'category': IndicatorCategory.STATISTICAL,
        'type': IndicatorType.SINGLE_VALUE,
        'description': 'Linear Regression (OPTIMIZED VERSION 🚀)',
    ...
    'percentile_rank': {
        ...
        'category': IndicatorCategory.STATISTICAL,
        'type': IndicatorType.SINGLE_VALUE,
        'description': 'Percentile Rank (Yüzdelik Dilim)',
    ...
    # INDICATORCATEGORY.STRUCTURE (10 indicators)
