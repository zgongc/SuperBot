...
INDICATOR_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    # 'COMMUNITY' (3 indicators)

    'alma_sd_bands': {
        'module': 'community.alma_sd_bands',
        'class': 'ALMAStdDevBands',
        'category': 'community',
        'type': IndicatorType.SINGLE_VALUE,
        'description': 'ALMA Standard Deviation Bands',
        'default_params': {'period': 111, 'offset': 0.85, 'sigma': 6.0, 'mult': 0.4, 'source': 'high', 'vol_smooth': 75, 'deadband_mult': 0.35},
    ...
    # INDICATORCATEGORY.TREND (20 indicators)
    ...
    'alma': {
        ...
        'default_params': {'period': 20, 'offset': 0.85, 'sigma': 6.0, 'source': 'close'},
        'requires_volume': False,
        'has_calculate_batch': True,
        'output_keys': ['alma']
    },
